...
class DigiDocServiceLocator:
    DigiDocService_address = "https://www.openxades.org:8443/DigiDocService"
...
class DigiDocServiceSOAP:
    ...
    # op: GetStatistics
    def GetStatistics(self, request, **kw):
        if isinstance(request, GetStatistics) is False:
            raise TypeError, "%s incorrect request type" % (request.__class__)
        # no input wsaction
        self.binding.Send(None, None, request, soapaction="", encodingStyle="http://schemas.xmlsoap.org/soap/encoding/", **kw)
        # no output wsaction
        typecode = Struct(pname=None, ofwhat=GetStatisticsResponse.typecode.ofwhat, pyclass=GetStatisticsResponse.typecode.pyclass)
        response = self.binding.Receive(typecode)
        return response
    ...
    # op: ReportMSSPStatus
    def ReportMSSPStatus(self, request, **kw):
        if isinstance(request, ReportMSSPStatus) is False:
            raise TypeError, "%s incorrect request type" % (request.__class__)
        # no input wsaction
        self.binding.Send(None, None, request, soapaction="", encodingStyle="http://schemas.xmlsoap.org/soap/encoding/", **kw)
        # no output wsaction
        typecode = Struct(pname=None, ofwhat=emptyResponse.typecode.ofwhat, pyclass=emptyResponse.typecode.pyclass)
        response = self.binding.Receive(typecode)
        return response
...
_MobileAuthenticateResponseTypecode = Struct(pname=("http://www.sk.ee/DigiDocService/DigiDocService_2_3.wsdl","MobileAuthenticateResponse"), ofwhat=[ZSI.TCnumbers.Iint(pname="Sesscode", aname="_Sesscode", typed=False, encoded=None, minOccurs=1, maxOccurs=1, nillable=True), ZSI.TC.String(pname="Status", aname="_Status", typed=False, encoded=None, minOccurs=1, maxOccurs=1, nillable=True), ZSI.TC.String(pname="UserIDCode", aname="_UserIDCode", typed=False, encoded=None, minOccurs=0, maxOccurs=1, nillable=True), ZSI.TC.String(pname="UserGivenname", aname="_UserGivenname", typed=False, encoded=None, minOccurs=0, maxOccurs=1, nillable=True), ZSI.TC.String(pname="UserSurname", aname="_UserSurname", typed=False, encoded=None, minOccurs=0, maxOccurs=1, nillable=True), ZSI.TC.String(pname="UserCountry", aname="_UserCountry", typed=False, encoded=None, minOccurs=1, maxOccurs=1, nillable=True), ZSI.TC.String(pname="UserCN", aname="_UserCN", typed=False, encoded=None, minOccurs=1, maxOccurs=1, nillable=True), ZSI.TC.String(pname="CertificateData", aname="_CertificateData", typed=False, encoded=None, minOccurs=1, maxOccurs=1, nillable=True), ZSI.TC.String(pname="ChallengeID", aname="_ChallengeID", typed=False, encoded=None, minOccurs=1, maxOccurs=1, nillable=True), ZSI.TC.String(pname="Challenge", aname="_Challenge", typed=False, encoded=None, minOccurs=1, maxOccurs=1, nillable=True), ZSI.TC.String(pname="RevocationData", aname="_RevocationData", typed=False, encoded=None, minOccurs=1, maxOccurs=1, nillable=True)], pyclass=None, encoded="http://www.sk.ee/DigiDocService/DigiDocService_2_3.wsdl")
...
_GetMobileAuthenticateStatusResponseTypecode = Struct(pname=("http://www.sk.ee/DigiDocService/DigiDocService_2_3.wsdl","GetMobileAuthenticateStatusResponse"), ofwhat=[ZSI.TC.String(pname="Status", aname="_Status", typed=False, encoded=None, minOccurs=1, maxOccurs=1, nillable=True), ZSI.TC.String(pname="Signature", aname="_Signature", typed=False, encoded=None, minOccurs=0, maxOccurs=1, nillable=True)], pyclass=None, encoded="http://www.sk.ee/DigiDocService/DigiDocService_2_3.wsdl")
...
_GetMobileCreateSignatureStatusResponseTypecode = Struct(pname=("http://www.sk.ee/DigiDocService/DigiDocService_2_3.wsdl","GetMobileCreateSignatureStatusResponse"), ofwhat=[ZSI.TCnumbers.Iint(pname="Sesscode", aname="_Sesscode", typed=False, encoded=None, minOccurs=1, maxOccurs=1, nillable=True), ZSI.TC.String(pname="Status", aname="_Status", typed=False, encoded=None, minOccurs=1, maxOccurs=1, nillable=True), ZSI.TC.String(pname="Signature", aname="_Signature", typed=False, encoded=None, minOccurs=0, maxOccurs=1, nillable=True)], pyclass=None, encoded="http://www.sk.ee/DigiDocService/DigiDocService_2_3.wsdl")
...
_GetStatisticsTypecode = Struct(pname=("http://www.sk.ee/DigiDocService/DigiDocService_2_3.wsdl","GetStatistics"), ofwhat=[], pyclass=None, encoded="http://www.sk.ee/DigiDocService/DigiDocService_2_3.wsdl")
class GetStatistics:
    typecode = _GetStatisticsTypecode
    __metaclass__ = pyclass_type
    def __init__(self, **kw):
        """Keyword parameters:
        """
GetStatistics.typecode.pyclass = GetStatistics

_GetStatisticsResponseTypecode = Struct(pname=("http://www.sk.ee/DigiDocService/DigiDocService_2_3.wsdl","GetStatisticsResponse"), ofwhat=[ZSI.TC.String(pname="ServiceStart", aname="_ServiceStart", typed=False, encoded=None, minOccurs=1, maxOccurs=1, nillable=True), ZSI.TC.String(pname="ConfigurationChange", aname="_ConfigurationChange", typed=False, encoded=None, minOccurs=1, maxOccurs=1, nillable=True), ZSI.TC.String(pname="DBStatus", aname="_DBStatus", typed=False, encoded=None, minOccurs=1, maxOccurs=1, nillable=True), ZSI.TCnumbers.Iint(pname="TotalSessions", aname="_TotalSessions", typed=False, encoded=None, minOccurs=1, maxOccurs=1, nillable=True), ZSI.TCnumbers.Iint(pname="ActiveSessions", aname="_ActiveSessions", typed=False, encoded=None, minOccurs=1, maxOccurs=1, nillable=True), ns0.ClientStatistics_Def(pname="ClientStats", aname="_ClientStats", typed=False, encoded=None, minOccurs=1, maxOccurs=1, nillable=True), ns0.OperatorStatistics_Def(pname="OperatorStats", aname="_OperatorStats", typed=False, encoded=None, minOccurs=1, maxOccurs=1, nillable=True), ns0.AsyncResponderStatistics_Def(pname="AsyncResponderStats", aname="_AsyncResponderStats", typed=False, encoded=None, minOccurs=1, maxOccurs=1, nillable=True)], pyclass=None, encoded="http://www.sk.ee/DigiDocService/DigiDocService_2_3.wsdl")
class GetStatisticsResponse:
    typecode = _GetStatisticsResponseTypecode
    __metaclass__ = pyclass_type
    def __init__(self, **kw):
        """Keyword parameters:
        ServiceStart -- part ServiceStart
        ConfigurationChange -- part ConfigurationChange
        DBStatus -- part DBStatus
        TotalSessions -- part TotalSessions
        ActiveSessions -- part ActiveSessions
        ClientStats -- part ClientStats
        OperatorStats -- part OperatorStats
        AsyncResponderStats -- part AsyncResponderStats
        """
        self._ServiceStart =  kw.get("ServiceStart")
        self._ConfigurationChange =  kw.get("ConfigurationChange")
        self._DBStatus =  kw.get("DBStatus")
        self._TotalSessions =  kw.get("TotalSessions")
        self._ActiveSessions =  kw.get("ActiveSessions")
        self._ClientStats =  kw.get("ClientStats")
        self._OperatorStats =  kw.get("OperatorStats")
        self._AsyncResponderStats =  kw.get("AsyncResponderStats")
GetStatisticsResponse.typecode.pyclass = GetStatisticsResponse
...
_ReportMSSPStatusTypecode = Struct(pname=("http://www.sk.ee/DigiDocService/DigiDocService_2_3.wsdl","ReportMSSPStatus"), ofwhat=[ZSI.TCnumbers.IpositiveInteger(pname="MSSP_TransID", aname="_MSSP_TransID", typed=False, encoded=None, minOccurs=1, maxOccurs=1, nillable=True), ns1.StatusType_Def(pname="Status", aname="_Status", typed=False, encoded=None, minOccurs=1, maxOccurs=1, nillable=True), ns1.SignatureType_Def(pname="MSS_Signature", aname="_MSS_Signature", typed=False, encoded=None, minOccurs=1, maxOccurs=1, nillable=True)], pyclass=None, encoded="http://www.sk.ee/DigiDocService/DigiDocService_2_3.wsdl")
class ReportMSSPStatus:
    typecode = _ReportMSSPStatusTypecode
    __metaclass__ = pyclass_type
    def __init__(self, **kw):
        """Keyword parameters:
        MSSP_TransID -- part MSSP_TransID
        Status -- part Status
        MSS_Signature -- part MSS_Signature
        """
        self._MSSP_TransID =  kw.get("MSSP_TransID")
        self._Status =  kw.get("Status")
        self._MSS_Signature =  kw.get("MSS_Signature")
ReportMSSPStatus.typecode.pyclass = ReportMSSPStatus

_emptyResponseTypecode = Struct(pname=("http://www.sk.ee/DigiDocService/DigiDocService_2_3.wsdl","ReportMSSPStatusResponse"), ofwhat=[], pyclass=None, encoded="http://www.sk.ee/DigiDocService/DigiDocService_2_3.wsdl")
class emptyResponse:
    typecode = _emptyResponseTypecode
    __metaclass__ = pyclass_type
    def __init__(self, **kw):
        """Keyword parameters:
        """
emptyResponse.typecode.pyclass = emptyResponse
